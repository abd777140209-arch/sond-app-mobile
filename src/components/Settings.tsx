...
export default function Settings({
  ...
  // 🎯 طريقة رفع الشعار المباشرة والمضمونة (مثل النسخة القديمة تماماً)
      ...
      <div className="lg:col-span-5 space-y-6">
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 pt-2 border-t border-slate-100">
            ...
            {/* زر الاستعادة بالطريقة البسيطة والمباشرة */}
            <button
              type="button"
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4">
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            {/* Custom Logo Upload Card - الطريقة البسيطة والمباشرة */}
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-1">
                ...
                <div className="space-y-2 flex-1 w-full text-right">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {/* زر رفع الشعار بالطريقة البسيطة والمباشرة */}
                    <button
                      type="button"
