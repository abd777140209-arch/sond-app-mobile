          ...
          <div className="space-y-2 pt-2 border-t border-slate-100">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              <button
                ...
                className="py-2.5 px-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-sm transition"
              >
              ...
              <button
                type="button"
                onClick={handleCopy}
                className="py-2.5 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs flex items-center justify-center gap-1.5 border border-slate-200 transition"
              >
